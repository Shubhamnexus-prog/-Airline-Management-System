...
public class BoardingPass extends JFrame implements ActionListener {
    ...
    public BoardingPass() {
        ...
        // image
        ImageIcon icon = new ImageIcon("src/airlinemanagementsystem/icons/airindia.png");
        Image img = icon.getImage().getScaledInstance(300,230,Image.SCALE_DEFAULT);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            if(rs.next()){
                ...
                JOptionPane.showMessageDialog(null,"Incorrect PNR");
